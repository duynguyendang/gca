...
func extractModifiers(query string) (*QueryModifier, string) {
	...
	extractLimit(query, upperQuery, modifier)
	extractOffset(query, upperQuery, modifier)
	extractOrderBy(query, modifier)
	extractGroupBy(query, modifier)
	extractAggregation(query, modifier)
...
// extractLimit parses the LIMIT clause from the query.
func extractLimit(query string, upperQuery string, modifier *QueryModifier) {
...
// extractOffset parses the OFFSET clause from the query.
func extractOffset(query string, upperQuery string, modifier *QueryModifier) {
...
// extractOrderBy parses the ORDER BY clause from the query.
func extractOrderBy(query string, modifier *QueryModifier) {
...
// extractGroupBy parses the GROUP BY clause from the query.
func extractGroupBy(query string, modifier *QueryModifier) {
...
// extractAggregation parses aggregation functions (COUNT, SUM, MIN, MAX) from the query.
func extractAggregation(query string, modifier *QueryModifier) {
